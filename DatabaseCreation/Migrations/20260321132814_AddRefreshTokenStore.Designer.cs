...
namespace DatabaseCreation.Migrations
{
    ...
    [Migration("20260321132814_AddRefreshTokenStore")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseCreation.Models.AdvanceAndDeduction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseCreation.Models.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseCreation.Models.Model", b =>
                {
                    ...
                    b.Property<decimal>("Price_Trader")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("DatabaseCreation.Models.OrderModel", b =>
                {
            ...
            modelBuilder.Entity("DatabaseCreation.Models.Phone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseCreation.Models.RefreshTokenStore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseCreation.Models.Revenue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseCreation.Models.Trader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseCreation.Models.Worker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseCreation.Models.AdvanceAndDeduction", b =>
                {
                    b.HasOne("DatabaseCreation.Models.Worker", "Worker")
            ...
            modelBuilder.Entity("DatabaseCreation.Models.OrderModel", b =>
                {
                    b.HasOne("DatabaseCreation.Models.Model", "Model")
                        .WithMany("OrderModels")
                        .HasForeignKey("Model_Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DatabaseCreation.Models.Order", "Order")
                        .WithMany("OrderModels")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DatabaseCreation.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
